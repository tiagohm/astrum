...
data class Nutation(
    ...
    companion object {
        ...
        fun compute(jde: Double): Nutation {
            ...
            if (abs(jde - lastJDENut) >= Consts.JD_HOUR) {
                lastJDENut = jde
                ...
                for (i in 0..77) {
                    val nut = NUT_2000B[i]
                    val theta = (nut.l * l + nut.ls * ls + nut.f * f + nut.d * d + nut.omega * omega).arcsecToRad
                ...
                deltaPsi = DeltaPsi.arcsecToRad
                deltaEpsilon = DeltaEpsilon.arcsecToRad
            }
