package br.tiagohm.astrum.core.algorithms.ephemeris
...
object Vsop87 {
    ...
    fun computeOsculatingCoordinates(jd0: Double, jd: Double, body: Int): DoubleArray {
        ...
        Algorithms.computeInterpolatedElements(t, elem, DIM, Vsop87::computeVsop87Elem, DELTA_T, ts, es)
    ...
    private val INSTRUCTIONS by lazy { readByteArrayFromResources("VSOP87_INSTRUCTIONS.dat") }

    private val CONSTANTS by lazy { readDoubleArrayFromResources("VSOP87_CONSTANTS.dat") }

    private val COEFFICIENTS by lazy { readDoubleArrayFromResources("VSOP87_COEFFICIENTS.dat") }
}