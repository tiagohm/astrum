...
import br.tiagohm.astrum.core.readByteArrayFromResources
import br.tiagohm.astrum.core.readDoubleArrayFromResources
...
object Elp82b {
    ...
    private fun computeSphericalCoordinates(t: Double, r: DoubleArray) {
        ...
        r[0] = (accu[0] + W[0]
                ...
                + t * (accu[6] + W[2]
                + t * (W[3]
                + t * W[4])))) * (Consts.M_PI / (180 * 3600))
        r[1] = (accu[1] + t * (accu[4] + t * accu[7])) * (Consts.M_PI / (180 * 3600))
    ...
    private val DEL = doubleArrayOf(
        (1732559343.73604 - 129597742.2758) * (Consts.M_PI / (180 * 3600)),
        (129597742.2758 - 1161.2283) * (Consts.M_PI / (180 * 3600)),
        (1732559343.73604 - 14643420.2632) * (Consts.M_PI / (180 * 3600)),
        (1732559343.73604 - -6967919.3622) * (Consts.M_PI / (180 * 3600)),
        (-5.8883 - -0.0202) * (Consts.M_PI / (180 * 3600)),
        (-0.0202 - 0.5327) * (Consts.M_PI / (180 * 3600)),
        (-5.8883 - -38.2776) * (Consts.M_PI / (180 * 3600)),
        (-5.8883 - 6.3622) * (Consts.M_PI / (180 * 3600)),
        (0.006604 - 9E-6) * (Consts.M_PI / (180 * 3600)),
        (9E-6 - -1.38E-4) * (Consts.M_PI / (180 * 3600)),
        (0.006604 - -0.045047) * (Consts.M_PI / (180 * 3600)),
        (0.006604 - 0.007625) * (Consts.M_PI / (180 * 3600)),
        (-3.169E-5 - 1.5E-7) * (Consts.M_PI / (180 * 3600)),
        (1.5E-7 - 0.0) * (Consts.M_PI / (180 * 3600)),
        (-3.169E-5 - 2.1301E-4) * (Consts.M_PI / (180 * 3600)),
        (-3.169E-5 - -3.586E-5) * (Consts.M_PI / (180 * 3600)),
    )

    private val P = doubleArrayOf(
        538101628.68898 * (Consts.M_PI / (180 * 3600)),
        210664136.43355 * (Consts.M_PI / (180 * 3600)),
        129597742.2758 * (Consts.M_PI / (180 * 3600)),
        68905077.59284 * (Consts.M_PI / (180 * 3600)),
        10925660.42861 * (Consts.M_PI / (180 * 3600)),
        4399609.65932 * (Consts.M_PI / (180 * 3600)),
        1542481.19393 * (Consts.M_PI / (180 * 3600)),
        786550.32074 * (Consts.M_PI / (180 * 3600)),
    )
    ...
    private const val ZETA = (1732559343.73604 + 5029.0966) * (Consts.M_PI / (180 * 3600))
